...
# Check for valid birth year 
    if "byr" in clean_passports[j]:
        ...
        if 1920 <= int(clean_passports[j]['byr']) <= 2002:
            ...
            print("Birthyear not between 1920 or 2002: " + str(clean_passports[j]['byr']))
            valid_byr += 0
    ...
    if "iyr" in clean_passports[j]:
        ...
        if 2010 <= int(clean_passports[j]['iyr']) <= 2020:
            ...
            print("Issue year not between 2010 and 2020: " + str(clean_passports[j]['iyr']))
            valid_iyr += 0
    ...
    if "eyr" in clean_passports[j]:
        ...
        if 2020 <= int(clean_passports[j]['eyr']) <= 2030:
            ...
            print("Exp year not between 2020 and 2030: " + str(clean_passports[j]['eyr']))
            valid_eyr += 0
